//
// "$Id: Hosts.cxx 46328 2018-05-25 21:55:10 $"
//
// tcpHost sshHost sftpHost confHost comHost
//
...
void Fl_Host::print( const char *fmt, ... ) 
{
	char buff[1024];
	va_list args;
...
/**********************************tcpHost******************************/
tcpHost::tcpHost(const char *address):Fl_Host() 
{
	term = NULL;
	bConnected = false;
...
int tcpHost::tcp()
{
	...
	if ( ::connect(so, (struct sockaddr *)&neaddr, addrsize)==-1 ) {
		return -2;
	}
	return so;
}
